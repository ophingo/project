...
//            if(existingUsersWithSameId.isPresent()){
//
//                        Users users = usersServiceAuditable.edit(existingUsersWithSameId.get(), username);
//                        UsersDto usersDto = usersMapper.map(users);
//                        message = messageService.getMessage(I18Code.MESSAGE_USER_ALREADY_EXISTS.getCode(),
//                                new String[]{}, locale);
//                        return new UsersResponse(false, message, ResponseCode.FAILED.getCode(), null, null);
//                    }
